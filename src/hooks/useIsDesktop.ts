 ...
 *
 * 900 rather than 1025 for one reason: a phone asked for the desktop site is
 * laid out at 980px wide and then scaled down. At 1025 that fell into the
 * mobile block, whose positions are fixed pixel offsets tuned for a phone, so
 * the hero lost its backlight and the Work cards overlapped. 980 belongs in the
 * desktop block, which is built for a canvas this size.
 */
